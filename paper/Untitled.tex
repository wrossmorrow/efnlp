...
\begin{tabular}{ r r c r c r r r r r r}
        &                  &             &                   &             &                   & min  & \multicolumn{2}{c}{\texttt{python}} & \multicolumn{2}{c}{\texttt{c++} -O3} \\ \cline{8-9} \cline{10-11}
 ...
 20 & 1,103,358 & 98.9\% & 1,106,345 & 99.2\% & 1.0 & 101MB & 144s & 13.8ms & 7.8s & 1.5$\mu$s \\  \hline
\end{tabular}
\end{small}
\end{center}
